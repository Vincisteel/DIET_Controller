...
data = pd.read_csv(r"C:\Users\achatter\Desktop\PhDResearch\DIET\Controller\py_inputs.dat", sep="\s+", skiprows=1,
...
next_state_txt = open(r"C:\Users\achatter\Desktop\PhDResearch\DIET\Controller\py_next_state.dat", "a")
...
action_txt = open(r"C:\Users\achatter\Desktop\PhDResearch\DIET\Controller\py_action.dat", "a")
action_txt.write('\t' + str(action) + '\n')
action_txt.close()

# Step 5: Store the reward in the text file
reward_txt = open(r"C:\Users\achatter\Desktop\PhDResearch\DIET\Controller\py_reward.dat", "a")
reward_txt.write('\t' + str(reward) + '\n')
reward_txt.close()

# Step 6: Store the pmv values in the text file
pmv_txt = open(r"C:\Users\achatter\Desktop\PhDResearch\DIET\Controller\py_pmv.dat", "a")
pmv_txt.write('\t' + str(pmv) + '\n')
pmv_txt.close()

# Step 7: Store the next state in the text file
state_txt = open(r"C:\Users\achatter\Desktop\PhDResearch\DIET\Controller\py_state.dat", "a")
...
fo = open(r"C:\Users\achatter\Desktop\PhDResearch\DIET\Controller\py_outputs.dat", "w")
fo.truncate(0)
fo.write('\t' + str(action) + '\t')
fo.close()
